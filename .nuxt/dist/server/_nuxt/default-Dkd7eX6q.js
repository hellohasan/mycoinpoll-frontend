...
import { mergeProps, withCtx, createVNode, createTextVNode, useSSRContext, ref, unref } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderSlot } from "vue/server-renderer";
import "hookable";
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</span></a></div><div class="button-wrapper d-flex align-items-center border-gradient"> NOt Ok </div></div></div></div></nav></div></header>`);
    };
  }
};
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const success = ref("");
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "subscribe-form" }, _attrs))} data-v-cda137f7><div class="message-container" data-v-cda137f7>`);
      if (unref(error)) {
        _push(`<p class="error-message" data-v-cda137f7>${ssrInterpolate(unref(error))}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(success)) {
        _push(`<p class="success-message" data-v-cda137f7>${ssrInterpolate(unref(success))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><form data-v-cda137f7><div class="subscribe-email mt-20" data-v-cda137f7><input${ssrRenderAttr("value", unref(email))} class="${ssrRenderClass({ error: unref(error) })}" required type="email" placeholder="Enter Your Email" data-v-cda137f7></div><input type="submit" class="btn1 primary-btn subscribe-btn mt-1"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""}${ssrRenderAttr("value", unref(loading) ? "Subscribing..." : "Subscribe")} data-v-cda137f7></form></div>`);
    };
  }
};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-cda137f7"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=default-Dkd7eX6q.js.map
