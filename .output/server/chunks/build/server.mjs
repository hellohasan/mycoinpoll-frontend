import { hasInjectionContext, inject, getCurrentInstance, ref, watchEffect, watch, unref, version, defineAsyncComponent, defineComponent, h, computed, provide, shallowReactive, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { c as createError$1, i as hasProtocol, j as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, $ as $fetch, m as baseURL, n as createHooks, t as toRouteMatcher, o as createRouter$1, q as defu, r as destr, v as klona, x as parse, y as getRequestHeader, z as isEqual, A as setCookie, B as getCookie, C as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./androverse-DTNDLX4w.mjs')
  },
  {
    name: "apply-launch",
    path: "/apply-launch",
    component: () => import('./apply-launch-DCc7rDxn.mjs')
  },
  {
    name: "auth-forgot-password",
    path: "/auth/forgot-password",
    component: () => import('./forgot-password-C_hnN8bP.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import('./login-De-SY2CS.mjs')
  },
  {
    name: "auth-reset-password",
    path: "/auth/reset-password",
    component: () => import('./reset-password-xFpK-XPr.mjs')
  },
  {
    name: "blog-detail-slug",
    path: "/blog-detail/:slug()",
    component: () => import('./_slug_-CyFguAYX.mjs')
  },
  {
    name: "blogs",
    path: "/blogs",
    component: () => import('./blogs-BU5pinFa.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-vB87570o.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DP6Gmjg5.mjs')
  },
  {
    name: "learn",
    path: "/learn",
    component: () => import('./learn-DwOabK8G.mjs')
  },
  {
    name: "news",
    path: "/news",
    component: () => import('./news-BzZ5ydF8.mjs')
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-Bx8TmNwt.mjs')
  },
  {
    name: "terms-conditions",
    path: "/terms-conditions",
    component: () => import('./terms-conditions-DuFZlkSJ.mjs')
  },
  {
    name: "token-slug",
    path: "/token/:slug()",
    component: () => import('./_slug_-BcN9NZ_-.mjs')
  }
];
...
const global_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B_k9s2Uo.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Ce19qvCH.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C5Ec-Yui.mjs'));
...
export { _export_sfc as _, useAuthStore as a, useRouter as b, useRuntimeConfig as c, useNuxtApp as d, entry$1 as default, asyncDataDefaults as e, createError as f, fetchDefaults as g, useRequestFetch as h, useRoute as i, nuxtLinkDefaults as j, useRequestEvent as k, navigateTo as n, resolveRouteObject as r, useHead as u };
