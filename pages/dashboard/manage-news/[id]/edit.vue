				...
				<form @submit.prevent="handelSubmit">
					<div class="custom-card-body">
						<div class="row gy-4">
							...
							<FormGroupPhoto col="col-md-6" v-model="form.image" :preview="form.image" :error="form.errors.get('image')" message="Size: 428x358" label="News Small Image" />
							<FormGroupPhoto col="col-md-6" v-model="form.image_large" :preview="form.image_large" :error="form.errors.get('image_large')" message="Size: 1232X626" label="News Large Image" />
...
<script setup>
	...
	await useOnlyFetch(`/manage-news/${route.params.id}/edit`, {
		onResponse({ response }) {
	...
	const handelSubmit = async () => {
		await form.submit(`/manage-news/${route.params.id}/update`, "PUT").then((res) => {
