				...
				<form @submit.prevent="handelSubmit">
					<div class="custom-card-body">
						<div class="row gy-4">
							...
							<FormGroupPhoto col="col-md-6" v-model="form.featured_image" :error="form.errors.get('featured_image')" message="Size: 1260X640" label="Featured Image" />
...
<script setup>
	...
	const handelSubmit = async () => {
		await form.submit('/manage-blogs').then((res) => {
